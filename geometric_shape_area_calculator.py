...
def main():
    ...
    # as a string (include a comma then a space between each option)
    ...
    # TODO: To verify that the variable 'choice' is indeed the integer data type, use conditional logic and print the output.  If converted correctly, the output in Terminal should print out 'True'.
    ...
    if choice == 1:  #DO NOT REMOVE THE 'IF'
        ...
        # TODO: If the user enters anything other than 1, 2 or 3, print this statement "Invalid choice ."
